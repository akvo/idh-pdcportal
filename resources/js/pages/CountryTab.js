  ...
  generateResources(params) {
        ...
        <Col md={reports.length === 1 ? 12 : 6} key={"report-" + i}>
          ...
          >
            ...
            <div className="d-flex justify-content-center">
              {this.state.download ? (
                <a
                  href={`/files/${x?.filename || file}${x.to}`}
                  onClick={(e) =>
                    userDownload(this.props.match.params.companyId)
                  }
                  target="_blank"
                  className={aClass}
                  style={{ width: "25rem" }}
    ...
    return (
      <>
        ...
        {/* ## FIXME :: Data Cleaning Report commented for now */}
        ...
        {/* ## FIXME :: EOL Data Cleaning Report commented for now */}
      </>
    );
  }
